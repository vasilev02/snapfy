              ...
              <div class="myform form ">
                 <form action="" method="post">
                  <div class="form-group">
                    <input type="text" name="fullName"  class="form-control my-input" id="fullName" placeholder="Full name" />
                 </div>
                  <div class="form-group">
                 ...
                 <div class="form-group">
                  <input type="email" name="email"  class="form-control my-input" id="email" placeholder="Email" />
                    ...
                    <div class="form-group">
                      <button class="btn btn-block g-button" type="submit">Sign up</button>
                    </div>
                 </form>
                 <p class="small mt-3">Have an account? <span><Link to="/login">Sign in</Link></span>
                 </p>
              </div>
           </div>
        </div>
